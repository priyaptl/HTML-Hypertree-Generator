...
public class tail extends JFrame
{
    private JTree tree;
    private String test; 
    int i;
  ...
  //  this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    this.tree = new JTree();
    final DefaultMutableTreeNode ROOT = new DefaultMutableTreeNode("my");
...
private void traverseRecursivly(Node docNode, DefaultMutableTreeNode treeNode) 
{
    ...
    for (Node nextChildDocNode : docNode.childNodes()) 
    {
        ...
        System.out.println("i  "+i);
         ...
         if(nextChildDocNode.nodeName()=="head" && nextChildDocNode.nodeName()=="head"){}
